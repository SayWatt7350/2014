...
#pragma config(Servo,  srvo_S1_C2_1,    FR_servo,             tServoNone)
#pragma config(Servo,  srvo_S1_C2_2,    FL_servo,             tServoNone)
#pragma config(Servo,  srvo_S1_C2_3,    BR_servo,             tServoNone)
#pragma config(Servo,  srvo_S1_C2_4,    BL_servo,             tServoNone)
