...
task main()
{
	...
	*/
	...
	wait1Msec(400);  // delay so don't overdraw current on servo block;
	//
	// change the rates on the swerve drive servos
	//
	servoChangeRate[frontRS] = 9;
	servoChangeRate[backRS] = 9;
	servoChangeRate[frontLS] = 9;
	servoChangeRate[backLS]= 9;
	...
	int lastservopos = 0;  // forces servos to turn straight
