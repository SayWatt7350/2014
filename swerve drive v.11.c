...
task main()
{
	...
	*/
	...
	else
	{
		...
		switch(under)
		{
	case 0:	servo[lock]=lockup;	break;
	case 1:	 servo[lock]=lockdown; PlaySound(soundBeepBeep); PlaySound(soundBeepBeep); PlaySound(soundBeepBeep); PlaySound(soundBeepBeep); PlaySound(soundBeepBeep); PlaySound(soundBeepBeep); break;
	case 2:		break;
	default: break;
	}
